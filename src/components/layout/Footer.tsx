...
const links = [["Sobre mim", "/#sobre"], ["Portfólio", "/#portfolio"], ["Media Kit", "/portfolio"], ["Parcerias", "/#parcerias"], ["Contato", "/#contato"]];
      ...
      <div className="container-shell grid gap-12 py-16 md:grid-cols-2 lg:grid-cols-[1.2fr_.8fr_1fr]">
        ...
        <div>
          ...
          <div className="mt-5 flex flex-col gap-4 text-white/65">
            ...
            <a className="flex items-center gap-3 hover:text-white" href={`mailto:${CONTACT.email}`}><Mail size={18} />{CONTACT.email}</a>
