...
export function Portfolio({ items }: { items: PortfolioVideo[] }) {
  ...
  const categories = ["Todos", ...Array.from(new Set(items.map((item) => item.category)))] as Array<"Todos" | PortfolioCategory>;
