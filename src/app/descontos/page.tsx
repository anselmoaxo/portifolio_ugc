...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "pt_BR",
    type: "website",
    images: [{ url: siteUrl("/og-image.png"), width: 1200, height: 630, alt: SITE.name }],
  },
  twitter: { card: "summary_large_image", images: [siteUrl("/og-image.png")], title: `${title} | ${SITE.name}`, description },
};
