    ...
    <article className="bg-cream pb-24 pt-36">
      <div className="container-shell max-w-3xl">
        ...
        <div className="mt-12 space-y-10 leading-8 text-muted">
          ...
          <PolicySection title="7. Contato">Dúvidas podem ser enviadas pelo Instagram <a className="text-rose-700 underline" href={CONTACT.instagram} target="_blank" rel="noopener noreferrer">{CONTACT.instagramHandle}</a>{CONTACT.email !== "EMAIL_DA_PRISCILA" ? <> ou pelo e-mail <a className="text-rose-700 underline" href={`mailto:${CONTACT.email}`}>{CONTACT.email}</a></> : ". O e-mail oficial será adicionado antes da publicação do site."}</PolicySection>
        </div>
